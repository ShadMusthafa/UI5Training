		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My First App",
									"targetURL": "#comstelmyUI5Appmyui5app-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comstelmyUI5Appmyui5app-display": {
								"semanticObject": "comstelmyUI5Appmyui5app",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.stel.myUI5App.myui5app",
									"url": sap.ui.require.toUrl("com/stel/myUI5App/myui5app")
								}
							}
						}
					}
